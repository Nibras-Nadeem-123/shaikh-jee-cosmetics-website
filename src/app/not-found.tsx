...
export const metadata: Metadata = {
    title: '404 - Page Not Found | Shaikh Jee Cosmetics',
    description: 'The page you are looking for could not be found. Explore our collection of premium cosmetics and skincare products.',
};
